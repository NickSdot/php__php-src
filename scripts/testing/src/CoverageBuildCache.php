...
final class CoverageBuildCache
{
    ...
    public static function key(string $repository, string $base, string $configuration): string
    {
        return hash('sha256', self::CACHE_VERSION . "\0$repository\0$base\0$configuration");
    }
